...
{
    /// <summary>
    /// Clase <see cref="IntNullableToEnumNullableMapper"/>
    /// </summary>
    public class IntNullableToEnumNullableMapper : IMemberInjection
    {
        private readonly Type enumType;
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="IntNullableToEnumNullableMapper"/>.
        /// </summary>
        /// <param name="enumType">Type of the enum.</param>
        public IntNullableToEnumNullableMapper(Type enumType)
        {
