...
namespace SIGEPROJ.BaseClasses.Mappers.TypeMappers
{
    ...
    /// </summary>
    public class EnumToStringMapper : IMemberInjection
    {
        /// <summary>
        /// 
        /// </summary>
        private static readonly EnumToStringMapper instance = new EnumToStringMapper();
        /// <summary>
        /// Gets the default.
        /// </summary>
        public static EnumToStringMapper Default
        {
            get
            {
                return instance;
