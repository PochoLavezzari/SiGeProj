...
namespace SIGEPROJ.BaseClasses.Mappers.TypeMapperStrategies
{
    ...
    /// </summary>
    public class StringToEnumNullableTypeMapperStrategy : ITypeMapperStrategy
    {
        /// <summary>
        ...
        public bool Match(StrategyConventionInfo info)
        {
            ...
            return info.SourceType == typeof(string) && nullableTargetType.IsSubclassOf(typeof(Enum));
        }
        ...
        public IMemberInjection GetInjecter(StrategyConventionInfo info)
        {
            ...
            return new StringToEnumNullableMapper(targetType);
        }
    }
}